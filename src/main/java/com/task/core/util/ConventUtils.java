...
public final class ConventUtils {
    ...
    public static int convertInt(Object obj){
        ...
        if(StringUtils.isNotBlank(obj)) return Integer.parseInt(obj.toString().trim());
    ...
    public static double convertDouble(Object obj){
        ...
        if(StringUtils.isNotBlank(obj)) return Double.parseDouble(obj.toString().trim());
    ...
    public static long convertLong(Object obj){
        ...
        if(StringUtils.isNotBlank(obj)) return Long.parseLong(obj.toString().trim());
        return 0L;
    }
